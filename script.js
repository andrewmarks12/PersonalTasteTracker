...
for (let l = 0; l < friendFavorites.length; l++) {
  if (friendFavorites[l].includes("a")) {
    foodsWithA.push(friendFavorites[l]);
  }
}
...
if (longFoodNames.length == shortFoodNames.length) {
  console.log("There are equal short and long-named foods.")
}
